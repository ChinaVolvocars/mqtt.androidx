package org.eclipse.paho.androidx.sample.components;
...
public class TextSelectComponent extends RelativeLayout {
    ...
    public TextSelectComponent(Context context, AttributeSet attr) {
        ...
        this.numberInput = attributeArray.getBoolean(R.styleable.TextSelectComponent_text_number, false);
        textSelectLayout.setOnClickListener(new OnClickListener() {
            @Override
